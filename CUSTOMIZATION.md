...
| `opensandbox` | `agent/integrations/opensandbox.py` | `OPEN_SANDBOX_API_KEY`, `OPEN_SANDBOX_DOMAIN`, `SANDBOX_TYPE="opensandbox"` — full setup in `customization/opensandbox-runbook.md` |
